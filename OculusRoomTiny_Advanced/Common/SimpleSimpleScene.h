...
*************************************************************************************/
#ifndef OVR_SimpleSimpleScene_h
#define OVR_SimpleSimpleScene_h
...
struct Scene
{
    ...
    {
        TriangleSet cube;
        cube.AddSolidColorBox(0.5f, -0.5f, 0.5f, -0.5f, 0.5f, -0.5f, 0x20404040);
        Add(
        ...
        */
        ...
        TriangleSet floors;
        floors.AddSolidColorBox(10.0f, -0.1f, 10.0f, -10.0f, 0.0f, -10.0f, 0x40808080); // Main floor
